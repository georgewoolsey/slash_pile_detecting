...
To enhance segmentation accuracy, the CIELAB and HSV models are used because they offer significant advantages over the standard RGB model, which can be sensitive to external variables ([Cheng et al. 2001](https://doi.org/10.1016/S0031-3203(00)00149-7); [Kior et al. 2024](https://doi.org/10.3390/plants13091262)). These models offer advantages over the RGB model by providing stability across different lighting conditions, varying sensors and flight plans, which focuses the color analysis. The CIELAB (L\*a\*b\*) model provides a perceptually uniform color space based on human vision, using L\* for lightness (0-100), a\* for green-red (towards red if a\* > 0, towards green if a\* < 0), and b\* for blue-yellow (towards yellow if b\* > 0, towards blue if b\* < 0). Studies have used the a\* component to perform vegetation segmentation and health ([Rigon et al. 2016](https://doi.org/10.1007/s11099-016-0214-x); [Riehle et al. 2020](https://doi.org/10.1016/j.compag.2019.105201)) and in the discrimination of wood products ([Moya et al. 2012](https://doi.org/10.3390/molecules17043639); [Amaral Reis et al. 2023](https://doi.org/10.1007/s00107-023-01953-4)). The HSV (Hue, Saturation and Value) model isolates the hue component to provide a color representation that is invariant to lighting variations and effectively separates the color from its saturation and brightness (i.e. the "value" component). In general the hue values of green vegetation vary from 50 to 150 degrees using a value range of 0-360 degrees ([Yang et al. 2015](https://doi.org/10.1016/j.inpa.2015.07.003); [Luo et al. 2024](https://doi.org/10.1088/1742-6596/2833/1/012012)).

We'll integrate the spectral indices listed in the table below that rely only on RGB data and have threshold values identified in the literature to distinguish green vegetation from dead/senescent vegetation and background soil or rock. For the thresholds meant to identify green vegetation we'll use the inverted threshold to keep candidate slash piles.
