...
### PSINF Mixed Conifer Site{#ptcld_process_psinf}
...
```{r,eval=F, results='hide', message=FALSE, fig.show='asis'}
...
```{r,eval=F,purl=FALSE, height = 8.5, width = 8}
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, include=FALSE}
remove(list = ls()[grep("_temp",ls())])
remove(plt_rast_combine, plt_rast_fn)
gc()
```
