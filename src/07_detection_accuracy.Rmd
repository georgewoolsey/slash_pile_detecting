...
terra_plt_gt_pred_match <- function(nm) {
...
neon_colors %>% 
  ...
  ggplot2::geom_text(mapping = ggplot2::aes(label = name, color = zzz), fontface = "bold", size = 3) +
