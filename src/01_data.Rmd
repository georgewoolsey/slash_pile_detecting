...
# grDevices::jpeg("c:/Users/georg/Downloads/xxx.jpeg", width = 8, height = 8, units = "in", res = 300)
...
# grDevices::jpeg("c:/Users/georg/Downloads/xxx.jpeg", width = 9, height = 7.2, units = "in", res = 300)
...
```{r,eval=F,purl=FALSE, fig.height=8, fig.width=8}
grDevices::jpeg("c:/Users/georg/Downloads/xxx.jpeg", width = 10, height = 8, units = "in", res = 300)
# mar = c(bottom, left, top, right)
terra::plotRGB(bhef_rgb_rast, stretch="lin", mar=c(2, 0.5, 3.5, 0.2))
# add stand boundary
terra::plot(
  bhef_stand_boundary %>% 
    terra::vect() %>% 
