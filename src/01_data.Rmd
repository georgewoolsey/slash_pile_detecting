...
```{r,eval=F,purl=FALSE, fig.height=9, fig.width=7.5}
...
terra::plotRGB(psinf_rgb_rast, stretch="lin", mar=c(2, 0.5, 3.5, 0.2))
# add stand boundary
terra::plot(
  psinf_stand_boundary %>% 
    terra::vect() %>% 
...
mtext("Pike and San Isabel National Forest (PSINF)", side = 3, line = 1.5, cex = 0.9, font = 2)
...
terra::plotRGB(pj_rgb_rast, stretch="lin", mar=c(0.2, 0.2, 1, 0.2))
# add stand boundary
terra::plot(
  pj_stand_boundary %>% 
    terra::vect() %>% 
...
# main title top: "side = 3", line = 1
mtext("Tres Rios Field Office (TRFO-BLM)", side = 3, line = 1.5, cex = 0.9, font = 2)
# sub title top: "side = 3", line = 1
mtext(
  paste0(
    all_stand_boundary %>% 
...
# mar = c(bottom, left, top, right)
terra::plotRGB(bhef_rgb_rast, stretch="lin", mar=c(1.5, 0.5, 0.5, 0.2))
# add stand boundary
terra::plot(
  bhef_stand_boundary %>% 
    terra::vect() %>% 
...
# main title top: "side = 3", line = 1
mtext("Black Hills Experimental Forest (BHEF)", side = 3, line = 1.5, cex = 0.9, font = 2)
# sub title top: "side = 3", line = 1
mtext(
  paste0(
    all_stand_boundary %>% 
...
# mar = c(bottom, left, top, right)
terra::plotRGB(arnf_rgb_rast, stretch="lin", mar=c(0.5, 0.5, 1, 0.2))
# add stand boundary
terra::plot(
  arnf_stand_boundary %>% 
    terra::vect() %>% 
...
# main title top: "side = 3", line = 1
mtext("Arapahoe and Roosevelt National Forest (ARNF)", side = 3, line = 1.5, cex = 0.9, font = 2)
# sub title top: "side = 3", line = 1
mtext(
  paste0(
    all_stand_boundary %>% 
