...
p_top_left <- diameter_comp_scatter1 + 
  theme(
    ...
    # plot.margin = margin(unit = "in", t = 0.11, r = 0.9, b = 0.11, l = 0.11) # Large 'b' (bottom) gap
...
p_top_right <- height_comp_scatter1 + 
  theme(
    plot.background = element_rect(color = "black", linewidth = 1, fill = NA),
    # plot.margin = margin(unit = "in", t = 0.11, r = 0.11, b = 0.11, l = 0.9) # Large 'b' (bottom) gap
    # , plot.margin = ggplot2::margin(t = 0.1, r = 0.1, b = 0.1, l = 0.1, unit = "in")
    , plot.title = ggplot2::element_blank()
    , plot.subtitle = ggplot2::element_blank()
  )
...
p_bottom_group <- wrap_elements(full = (
  ...
  plot_annotation(
    theme = theme(
      # This draws the box around the 4-plot unit
      plot.background = element_rect(color = "black", linewidth = 1, fill = NA)
      # , plot.margin = ggplot2::margin(t = 0.1, r = 0.1, b = 0.1, l = 0.1, unit = "in")
    )
  )
...
final_layout <- 
  ...
  p_bottom_group + 
  plot_layout(
    heights = c(0.05, 1, 0.05, 2),
    guides = 'collect'
  ) +
  plot_annotation(
    tag_levels = list(c("Tag A", "Tag B", "Group Tag"))
  ) & 
  theme(
    plot.tag = element_text(face = "bold", size = 14),
    plot.tag.position = c(0.1, 1.05) # Keeps tags above the boxes
    , plot.margin = ggplot2::margin(t = 0.1, r = 0.1, b = 0.1, l = 0.1, unit = "in")
  )

# final_layout
ggplot2::ggsave("../data/all_comp_scatter2.jpeg", plot = final_layout, height = 9.9, width = 8.5, dpi = 300)
...
# scales::percent(summary(lm_temp)$r.squared, accuracy = 1)
...
```{r, results=F, include=F, eval=T}
ggplot2::ggsave("../data/all_comp_treatment_total.jpeg", plot = p_temp, height = 8, width = 10, dpi = 300)
```
