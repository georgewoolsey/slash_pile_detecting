...
```{r, include = F, eval = F}
x_temp <- (psinf_slash_piles_polys %>% 
    dplyr::filter(
      !is_in_stand
      & pile_id %in% c(53,52,63,20,17,11,6,75)
      # & pile_id %in% c(53,52,63,20,17,30,27)
    ))
...
```{r, include=F, eval=F}
xxx_temp <- psinf_slash_piles_polys %>% 
  dplyr::filter(
    !is_in_stand
    & pile_id %in% c(53,52,63,20,17,11,6,75)
  ) %>% 
...
yyy_temp <- psinf_slash_piles_polys %>% 
  dplyr::inner_join(
    psinf_slash_piles_polys %>% 
      sf::st_intersection(xxx_temp) %>% 
      sf::st_drop_geometry() %>% 
...
zzz_temp <- 
  ...
  terra::subset(1) %>% 
  terra::crop(
    xxx_temp %>% sf::st_buffer(4) %>% terra::vect()
    , mask = T
  ) 

terra::plot(zzz_temp, axes = F, legend=F)
terra::plot(xxx_temp, add = T, border = "black", col = NA)
terra::plot(yyy_temp, add = T, border = "cyan", col = NA)

terra::clamp(zzz_temp, upper = 6, lower = 0, values = F) %>% 
  terra::plot(axes = F, legend=F)
terra::plot(xxx_temp, add = T, border = "black", col = NA)
terra::plot(yyy_temp, add = T, border = "cyan", col = NA)
```
...
ggplot2::ggsave(filename = "../data/workflow_ex_01_chm.jpg", height = 8, width = 4.6)
p_temp <-
  plt_aoi_chm(aoi_chm_rast,"cividis") +
  ggplot2::geom_sf(
    data = aoi_slash_piles_polys
    , fill = NA, color = "cyan", lwd = 0.95
  )
ggplot2::ggsave(plot = p_temp, filename = "../data/workflow_ex_011_chm_piles.jpg", height = 8, width = 4.6)
p_temp <- p_temp +
  ggplot2::theme(
    legend.position = "none"
    # legend.key.height = unit(0.01, "cm")
    # , legend.text = ggplot2::element_text(size = 0.01)
    # , legend.title = ggplot2::element_text(size = 0.01)
  )
ggplot2::ggsave(plot = p_temp, filename = "../data/workflow_ex_012_chm_noleg.jpg", height = 8, width = 4.6)
```
...
```{r, include=FALSE,eval=TRUE}
ggplot2::ggsave(filename = "../data/workflow_ex_02_rgb.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_03_rgb.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_03_rgb_chm.jpg", height = 8, width = 4.6)
```
...
```{r, include=FALSE,eval=TRUE}
p_temp <- plt_aoi_chm(aoi_chm_rast_slice) +
  ggplot2::geom_sf(
    data = aoi_slash_piles_polys
    , fill = NA, color = "cyan", lwd = 1.02
  )
ggplot2::ggsave(plot = p_temp, filename = "../data/workflow_ex_04_chm.jpg", height = 8, width = 4.6)
```
...
### Overview of Methods{#seg_methods}
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_05_rgb_wshed_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r, include=FALSE,eval=TRUE}
plt_temp <- plt_aoi_chm(aoi_chm_rast_slice) +
  ggplot2::geom_sf(
    data = aoi_slash_piles_polys
...
ggplot2::ggsave(plot = plt_temp, filename = "../data/workflow_ex_05_chm_wshed_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_05_rgb_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r, include=FALSE,eval=TRUE}
p_hrrr <- plt_aoi_chm(aoi_chm_rast_slice) +
  ggplot2::geom_sf(
    data = aoi_slash_piles_polys
    , fill = NA, color = "cyan", lwd = 1.02
  ) +
  ggplot2::geom_sf(
    data = dbscan_segs %>% 
      ...
      sf::st_make_valid() %>% 
      dplyr::filter(sf::st_is_valid(.))
    , fill = NA, color = "magenta", lwd = 0.9
  ) + ggplot2::theme(legend.position = "none")
ggplot2::ggsave(plot = p_hrrr, filename = "../data/workflow_ex_05_chm_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_06_rgb_wshed_cnddts.jpg", height = 8, width = 4.6)
```
...
ggplot2::ggsave(plot = p_temp, filename = "../data/workflow_ex_06_chm_wshed_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_06_rgb_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
ggplot2::ggsave(plot = p_temp, filename = "../data/workflow_ex_06_chm_dbscan_cnddts.jpg", height = 8, width = 4.6)
...
ggplot2::ggsave(plot = p_hrrr, filename = "../data/workflow_ex_0600_chm_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
ggplot2::ggsave(filename = "../data/workflow_ex_07_rgb_watershed_cnddts.jpg", height = 8, width = 4.6)

# plot the filtered watershed candidate segments (magenta) and convex hull of the segments (orange) and the actual piles (cyan) on the CHM
...
ggplot2::ggsave(filename = "../data/workflow_ex_07_chm_watershed_cnddts.jpg", height = 8, width = 4.6)
...
ggplot2::ggsave(filename = "../data/workflow_ex_07_rgb_dbscan_cnddts.jpg", height = 8, width = 4.6)

# plot the filtered dbscan candidate segments (magenta) and convex hull of the segments (orange) and the actual piles (cyan) on the CHM
...
ggplot2::ggsave(filename = "../data/workflow_ex_07_chm_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
ggplot2::ggsave(plot=p_temp,filename = "../data/workflow_ex_0700_chm_watershed_cnddts.jpg", height = 8, width = 4.6)
# plotting
p_temp <-
  plt_aoi_chm(aoi_chm_rast_slice) +
  ggplot2::geom_sf(
...
ggplot2::ggsave(plot=p_temp,filename = "../data/workflow_ex_0700_chm_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_0701_rgb_watershed_cnddts.jpg", height = 8, width = 4.6)
```
...
ggplot2::ggsave(plot=p_temp,filename = "../data/workflow_ex_0701_chm_watershed_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_0701_rgb_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
ggplot2::ggsave(plot=p_temp,filename = "../data/workflow_ex_0701_chm_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
ggplot2::ggsave(filename = "../data/workflow_ex_08_rgb_watershed_cnddts.jpg", height = 8, width = 4.6)
...
ggplot2::ggsave(filename = "../data/workflow_ex_08_chm_watershed_cnddts.jpg", height = 8, width = 4.6)
...
ggplot2::ggsave(filename = "../data/workflow_ex_08_rgb_dbscan_cnddts.jpg", height = 8, width = 4.6)
...
ggplot2::ggsave(filename = "../data/workflow_ex_08_chm_dbscan_cnddts.jpg", height = 8, width = 4.6)
...
ggplot2::ggsave(plot=p_temp,filename = "../data/workflow_ex_0800_chm_watershed_cnddts.jpg", height = 8, width = 4.6)
# plotting
p_temp <-
  plt_aoi_chm(aoi_chm_rast_slice) +
  ggplot2::geom_sf(
...
ggplot2::ggsave(plot=p_temp,filename = "../data/workflow_ex_0800_chm_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_0801_rgb_watershed_cnddts.jpg", height = 8, width = 4.6)
```
...
ggplot2::ggsave(plot=p_temp,filename = "../data/workflow_ex_0801_chm_watershed_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_0801_rgb_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
ggplot2::ggsave(plot=p_temp,filename = "../data/workflow_ex_0801_chm_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_09_rgb_wshed_cnddts.jpg", height = 8, width = 4.6)
```
...
ggplot2::ggsave(plot=p_temp,filename = "../data/workflow_ex_09_chm_wshed_cnddts.jpg", height = 8, width = 4.6)
```
...
```{r,eval=F,purl=F, include=FALSE}
ggplot2::ggsave(filename = "../data/workflow_ex_09_rgb_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
p_temp <- plt_aoi_chm(aoi_chm_rast_slice) +
  ...
  ggplot2::theme(legend.position = "none")
ggplot2::ggsave(plot=p_temp,filename = "../data/workflow_ex_09_chm_dbscan_cnddts.jpg", height = 8, width = 4.6)
```
...
## Pile Detection Function{#slash_pile_detect_fn}
...
# add preds
terra::plot(
  watershed_structural_preds$pj %>%
    sf::st_transform(terra::crs(pj_rgb_rast)) %>%
    terra::vect()
  , add = T, border = "magenta", col = NA, lwd = 1.5
)
  
mapview::mapview(pj_stand_boundary, color = "black", lwd = 1, alpha.regions = 0, label = FALSE, popup = FALSE) +
  mapview::mapview(pj_slash_piles_polys)

aoi_boundary <- 
  pj_slash_piles_polys %>% 
  dplyr::filter(
    # pile_id %in% c(18,19,20,21) # bhef
    # pile_id %in% c(15,14) # bhef
    pile_id %in% c(41,146,160,63)
  ) %>% 
  sf::st_union() %>% 
  sf::st_bbox() %>% 
  sf::st_as_sfc() %>% 
  sf::st_buffer(30, joinStyle = "MITRE") %>% 
  sf::st_as_sf() %>% 
  dplyr::mutate(dummy=1)
terra::plot(
  aoi_boundary %>% 
    sf::st_transform(terra::crs(pj_rgb_rast)) %>% 
    terra::vect()
  , add = T, border = "white", col = NA, lwd = 3
)

aoi_rgb_rast <- pj_rgb_rast %>% 
    terra::crop(
      aoi_boundary %>% 
        sf::st_buffer(2) %>% 
        sf::st_transform(terra::crs(pj_rgb_rast)) %>% 
...
aoi_chm_rast <- 
  # terra::rast("../data/BHEF_202306/bhef_chm_rast_0.15m.tif") %>% 
  pj_chm_rast %>% 
    terra::crop(
      aoi_boundary %>% 
        sf::st_buffer(2) %>% 
        sf::st_transform(terra::crs(pj_chm_rast)) %>% 
        terra::vect()
      , mask = T
    )
aoi_slash_piles_polys <- pj_slash_piles_polys %>% 
  dplyr::inner_join(
    pj_slash_piles_polys %>% 
      dplyr::filter(is_in_stand) %>% 
      sf::st_intersection(aoi_boundary) %>% 
...
slash_pile_detect_watershed_ans_temp <- slash_pile_detect(
  ...
  , min_area_m2 = 2
  , max_area_m2 = 22.5
  , min_convexity_ratio = 0
  , min_circularity_ratio = 0
  , smooth_segs = F
)
slash_pile_detect_watershed_ans_temp$segs_sf %>% dplyr::glimpse()
slash_pile_detect_watershed_ans_temp$slice_chm_rast %>% terra::plot()
st_convexity_filter(slash_pile_detect_watershed_ans_temp$segs_sf, min_convexity_ratio = 0.01) %>% 
  dplyr::glimpse()

# mapview::mapview(aoi_chm_rast)
terra::plot(aoi_chm_rast, axes = F)
terra::plot(slash_pile_detect_watershed_ans_temp$slice_chm_rast, axes = F)
terra::plotRGB(aoi_rgb_rast, stretch = "lin")
# add piles
terra::plot(
  aoi_slash_piles_polys %>% 
...
# add preds
terra::plot(
  slash_pile_detect_watershed_ans_temp$segs_sf %>% 
    sf::st_transform(terra::crs(aoi_rgb_rast)) %>% 
    terra::vect()
  , add = T, border = "magenta", col = NA, lwd = 1.5
)
...
#     sf::st_transform(terra::crs(pj_rgb_rast)) %>% 
#     terra::vect()
#   , add = T, border = "red", col = NA, lwd = 1.1
# )

sf::st_intersection(
  aoi_slash_piles_polys %>% sf::st_transform(terra::crs(aoi_chm_rast))
  , slash_pile_detect_watershed_ans_temp$segs_sf %>% sf::st_union()
) %>% 
  nrow()
  sf::st_transform(terra::crs(aoi_rgb_rast)) %>% 
  terra::vect() %>% 
terra::plot(
  , add = T, border = "red", col = NA, lwd = 1.5
)


mapview::mapview(aoi_boundary, color = "black", lwd = 1, alpha.regions = 0, label = FALSE, popup = FALSE) +
  mapview::mapview(aoi_slash_piles_polys, color = "cyan") +
  mapview::mapview(st_convexity_filter(slash_pile_detect_watershed_ans_temp$segs_sf, min_convexity_ratio = 0.01), color = "magenta")
# mapview::mapview(slash_pile_detect_watershed_ans_temp$segs_sf, color = "magenta")
```
